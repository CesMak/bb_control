###########################################################################
## Makefile generated for Simulink model 'Sim_NL_XZ'. 
## 
## Makefile     : Sim_NL_XZ.mk
## Generated on : Thu Dec 14 10:46:57 2017
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: ./Sim_NL_XZ_rtwlib.lib
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Sim_NL_XZ_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ../../..
MODELREF_LINK_RSPFILE     = Sim_NL_XZ_ref.rsp
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/slprj/ert/Sim_NL_XZ -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils
...
DEFINES_STANDARD = -DMODEL=Sim_NL_XZ -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/ert/Sim_NL_XZ/Sim_NL_XZ.c
...
%.obj : $(START_DIR)/slprj/ert/Sim_NL_XZ/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
