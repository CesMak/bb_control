###########################################################################
## Makefile generated for Simulink model 'Torque_Transformation'. 
## 
## Makefile     : Torque_Transformation.mk
## Generated on : Thu Dec 14 10:48:04 2017
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: ./Torque_Transformation_rtwlib.lib
...
PRODUCT_NAME              = Torque_Transformation
MAKEFILE                  = Torque_Transformation.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/BallBot/Controller/bb_control
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Torque_Transformation_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ../../..
MODELREF_LINK_RSPFILE     = Torque_Transformation_ref.rsp
...
MODELLIB                  = Torque_Transformation_rtwlib.lib
MODELREFS                 = 
MODELREF_LINK_LIBS        = 
SHARED_OBJS               =  \
...
PRODUCT = ./Torque_Transformation_rtwlib.lib
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/slprj/ert/Torque_Transformation -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils
...
DEFINES_STANDARD = -DMODEL=Torque_Transformation -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/ert/Torque_Transformation/Torque_Transformation.c
...
OBJS = Torque_Transformation.obj
...
%.obj : $(START_DIR)/slprj/ert/Torque_Transformation/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
