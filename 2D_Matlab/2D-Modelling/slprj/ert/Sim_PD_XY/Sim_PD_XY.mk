###########################################################################
## Makefile generated for Simulink model 'Sim_PD_XY'. 
## 
## Makefile     : Sim_PD_XY.mk
## Generated on : Thu Dec 14 10:47:50 2017
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: ./Sim_PD_XY_rtwlib.lib
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Sim_PD_XY_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ../../..
MODELREF_LINK_RSPFILE     = Sim_PD_XY_ref.rsp
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/slprj/ert/Sim_PD_XY -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils
...
DEFINES_STANDARD = -DMODEL=Sim_PD_XY -DNUMST=2 -DNCSTATES=3 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/ert/Sim_PD_XY/Sim_PD_XY.c
...
%.obj : $(START_DIR)/slprj/ert/Sim_PD_XY/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
